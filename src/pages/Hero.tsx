...
import nutriFotoSemBg from '../assets/nutri_renata_sembg.png';
  ...
  return (
    <div className="relative bg-white overflow-hidden dark:bg-gray-900">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <div className=" sm:hidden"> 
                <img src={nutriFotoSemBg} alt="Nutricionista" className="h-96 w-full object-cover rounded-lg" />
              </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          className="hidden sm:block h-56 w-full object-cover 
          sm:h-72  
          md:h-96 
          lg:w-full lg:h-full"
          src={bgHome}
